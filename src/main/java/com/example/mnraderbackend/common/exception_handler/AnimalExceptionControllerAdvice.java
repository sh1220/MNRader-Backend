...
public class AnimalExceptionControllerAdvice {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(AnimalException.class)
    public BaseErrorResponse handle_AnimalException(AnimalException e) {
        log.error("[handle_AnimalException] {}", e.getMessage());
